...
return(
    ...
    <article className="group relative">
              <div className="backdrop-blur-sm bg-white/20 rounded-3xl p-8 border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:bg-white/30">
                <div className={`w-16 h-16 rounded-2xl ${props.gradient || 'bg-gradient-to-r from-amber-500 to-yellow-600'} flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300`} aria-hidden="true">
