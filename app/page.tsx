  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FCF8F2' }}>
      ...
      <section id="explainer" className="py-32 bg-gradient-to-br from-yellow-50 via-amber-50 to-orange-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-yellow-200 to-amber-200 border-2 border-yellow-300 mb-8 shadow-lg">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                <div className="group">
                  <div className="backdrop-blur-sm bg-white/20 rounded-2xl p-6 border border-white/30 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                    <div className="flex items-start space-x-4">
                      <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-amber-500 to-orange-600 flex items-center justify-center flex-shrink-0">
                        <span className="text-white font-bold text-lg">1</span>
                      </div>
                      <div>
                        <h3 className="text-xl font-bold mb-2 text-gray-800">Create Tasks</h3>
                        <p className="text-gray-600">Add tasks with priorities, categories, and due dates. Organize your work with beautiful drag-and-drop interface.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="group">
                  <div className="backdrop-blur-sm bg-white/20 rounded-2xl p-6 border border-white/30 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-2 text-gray-800">Plan Your Day</h3>
                        <p className="text-gray-600">Schedule tasks in your daily planner with hourly time slots. Visual planning made simple and intuitive.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="group">
                  <div className="backdrop-blur-sm bg-white/20 rounded-2xl p-6 border border-white/30 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                    <div className="flex items-start space-x-4">
                      <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-yellow-500 to-amber-600 flex items-center justify-center flex-shrink-0">
                        <span className="text-white font-bold text-lg">3</span>
                      </div>
              <div>
                        <h3 className="text-xl font-bold mb-2 text-gray-800">Track Progress</h3>
                        <p className="text-gray-600">Monitor your productivity with analytics, streaks, and insights. Your data stays secure with encrypted storage.</p>
                      </div>
                    </div>
              </div>
                </div>
              ...
              <div className="relative">
                <div className="backdrop-blur-sm bg-white/20 rounded-3xl p-8 border border-white/30 shadow-2xl">
                  <div className="aspect-square rounded-2xl bg-gradient-to-br from-pink-100 via-purple-100 to-indigo-100 flex items-center justify-center relative overflow-hidden">
                    {/* Mock UI Elements */}
                    <div className="absolute inset-4 bg-white/50 rounded-xl p-4">
                      <div className="space-y-3">
                        <div className="h-3 bg-gradient-to-r from-amber-400 to-orange-500 rounded-full w-3/4"></div>
                        <div className="h-3 bg-gradient-to-r from-orange-400 to-red-500 rounded-full w-1/2"></div>
                        <div className="h-3 bg-gradient-to-r from-yellow-400 to-amber-500 rounded-full w-2/3"></div>
                        <div className="h-3 bg-gradient-to-r from-red-400 to-pink-500 rounded-full w-4/5"></div>
                      </div>
                    </div>
                    <div className="absolute top-4 right-4 w-8 h-8 bg-gradient-to-r from-amber-500 to-orange-600 rounded-full flex items-center justify-center">
                ...
                {/* Floating Elements */}
                <div className="absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-r from-amber-400 to-orange-500 rounded-full blur-xl opacity-60 animate-pulse"></div>
                <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-gradient-to-r from-yellow-400 to-amber-500 rounded-full blur-xl opacity-40 animate-bounce"></div>
            </div>
            </div>
          </div>
        </div>
